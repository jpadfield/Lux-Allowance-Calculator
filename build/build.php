...
$versions = array_merge($versions, $versions_new);

$default_scripts = array(

	"js-scripts" => array (
		"jquery" => "https://cdn.jsdelivr.net/npm/jquery@".$versions["jquery"]."/dist/jquery.min.js\" crossorigin=\"anonymous"
	...
	"css-scripts" => array(
		"fontawesome" => "https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@".$versions["fontawsome"]."/css/all.min.css\" crossorigin=\"anonymous"
		,"bootstrap" => "https://cdn.jsdelivr.net/npm/bootstrap@".$versions["bootstrap"]."/dist/css/bootstrap.css\" crossorigin=\"anonymous"
		,"json-viewer" => "https://cdn.jsdelivr.net/npm/jquery.json-viewer@".$versions["json-viewer"]."/json-viewer/jquery.json-viewer.css\" crossorigin=\"anonymous"
		,"highlight" => "https://cdn.jsdelivr.net/npm/highlight.js@".$versions["highlight.js"]."/styles/github.css\" crossorigin=\"anonymous"
